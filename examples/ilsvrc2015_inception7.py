...
l_inception6_3a = googlenet.add_inception_7(l_pool2, counter = 'inception_3a', **inception3a_kwargs)
l_inception6_3b = googlenet.add_inception_7(l_inception6_3a, counter = 'inception_3b', **inception3b_kwargs)
l_inception6_3c = googlenet.add_inception_7(l_inception6_3b, counter = 'inception_3c', **inception3c_kwargs)

l_inception6_4a = googlenet.add_inception_7(l_inception6_3c, counter = 'inception_4a', **inception4a_kwargs)
l_inception6_4b = googlenet.add_inception_7(l_inception6_4a, counter = 'inception_4b', **inception4b_kwargs)
l_inception6_4c = googlenet.add_inception_7(l_inception6_4b, counter = 'inception_4c', **inception4c_kwargs)
l_inception6_4d = googlenet.add_inception_7(l_inception6_4c, counter = 'inception_4d', **inception4d_kwargs)
l_inception6_4e = googlenet.add_inception_7(l_inception6_4d, counter = 'inception_4e', **inception4e_kwargs)

l_inception6_5a = googlenet.add_inception_7(l_inception6_4e, counter = 'inception_5a', **inception5a_kwargs)
l_inception6_5b = googlenet.add_inception_7(l_inception6_5a, counter = 'inception_5b', **inception5b_kwargs)
...
text_file = open("ilsvrc2015_inception7.prototxt", "w")
text_file.write('name: \"Inception7\"\n')
text_file.write(str(googlenet))
text_file.close()

# In[]: Print network information
caffe.set_mode_cpu()
net = caffe.Net('ilsvrc2015_inception7.prototxt', caffe.TEST)
